        ...
        <ModalBody color={color}>
          <FormControl>
            <Flex alignItems={'center'}>
              <FormLabel htmlFor="person" fontSize={'xl'} marginBottom={0}>
                As a
              </FormLabel>
              <Input
                id="person"
          ...
          <FormControl mt={4}>
            <Flex alignItems={'center'}>
              <FormLabel htmlFor="todo" fontSize={'xl'} marginBottom={0}>
                I need
              </FormLabel>
              <Input
                id="todo"
                ...
                onChange={(e) => {
                  ...
                  setIsValidINeed(isValidInput(e.target.value));
                }}
              />
            </Flex>
          </FormControl>
            ...
            <Flex alignItems={'center'}>
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  setIsValidSoThat(isValidInput(e.target.value));
                }}
              />
            </Flex>
          </FormControl>
          ...
          <FormControl mt={4}>
            ...
            <Select
              ...
              onChange={(e) => {
                setCard({ ...card, participant: e.target.value });
              }}
            >
              {participants &&
